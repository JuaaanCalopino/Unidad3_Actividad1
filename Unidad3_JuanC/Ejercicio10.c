...
void restarMatrices(int filas, int columnas, float matriz1[filas][columnas], float matriz2[filas][columnas], float resultado[filas][columnas]) {
    for (int i = 0; i < filas; i++) {
        for (int j = 0; j < columnas; j++) {
...
int main() {
    ...
    // restar las matrices
    restarMatrices(filas, columnas, matriz1, matriz2, resultado);
